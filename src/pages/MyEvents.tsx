    ...
    return (
        <div className="min-h-[80vh] flex justify-center items-start max-w-7xl mx-auto px-2 lg:px-8 py-8">
            ...
            <div className="col-span-12 md:col-span-5 w-full">
                ...
                {!myEvents || myEvents?.length == 0 ? (<div className="flex-col my-16">
                    <div className="flex justify-center">
                        <img src="/empty-box.svg" alt="empty box to show no personal event" className="h-16 w-16 text-center " />
                    </div>  
                    <h3 className="text-gray-900">{searchValue? 'No matching events found. Try a different search.':'No personal events found'}</h3>
                </div>) : (
                    <div className=" w-full flex-col ">
                        <div >
                            ...
                            {searchValue && (<h6 className="text-gray-500 text-start">{`Results: ${myEvents.length} events found`}</h6>)}
