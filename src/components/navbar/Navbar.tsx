...
const Navbar = () => {
    return (
        <>
            <nav className="border-b w-full border-gray-300 pb-4  ">
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4 mt-[30px]">
                                    ...
                                    <NavLink to="/"            className={ " rounded-md px-3 py-2 text-sm font-medium"} >Home</NavLink>
                                    <NavLink to="/festivals"   className={ " rounded-md px-3 py-2 text-sm font-medium"}>Festivals</NavLink>
                                    <NavLink to="convert-date" className={ " rounded-md px-3 py-2 text-sm font-medium"}>Date Converter</NavLink>
                                </div>
                            </div>
                        </div>
